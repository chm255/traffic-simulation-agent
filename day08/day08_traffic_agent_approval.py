...
def route_after_llm(
    ...
    print()
    print(
        "Running Router: route_after_llm"
    )
    ...
    # --------------------------------------------------------
    # Check whether any Tool needs approval
    # --------------------------------------------------------
    ...
    for tool_call in tool_calls:
        ...
        if (
            ...
            result = {
                ...
                "message":
                    "The tool call was not "
                    "executed because human "
                    "approval was denied.",
            }

        # ----------------------------------------------------
        # Safe Tool -> still allowed
        # ----------------------------------------------------
